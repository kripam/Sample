			...
			<div class="scroll">
		 	...
		 	if (isset($_POST['submit'])) {
				...
				$curpassword=$_POST['curpassword'];
				 ...
				 $sql1="SELECT `password`  FROM `teacher` WHERE `teacher`.`teacherid` = $teacherid";
...
{
				 $sql2="UPDATE `attendancetracker`.`teacher` SET `password` = '$newpassword' WHERE `teacher`.`teacherid` = $teacherid";
