	...
	<div id="tooplate_wrapper">
		...
		<div class="form-group">
              	  ...
              	  <option value="lname">last name</option>
              	   <option value="semsester">semester</option>
              	    <option value="dpnum">department</option>
              	     <option value="pemail">parents email</option>
              	      <option value="email">email</option>
              	       <option value="adminno">admission no</option>
    ...
    <div id="footer_left">
		...
		if(isset($_POST['submit'])){
			...
			$con =mysqli_connect('localhost', 'root', '', 'attendancetracker');
			 $sql="UPDATE `attendancetracker`.`student` SET `$attribute` = '$newval' WHERE `student`.`adminno` = $adminno";
