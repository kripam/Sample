          ...
          <div class="scroll">
            <div class="scrollContainer">
				...
				<div class="form-group">
					...
					<input type="password" name="curpass" placeholder="Enter current password"class="input_field">
                      <div class="cleaner_h10"></div>
				</div>
				
				<div class="form-group">
					<label>New Password</label>
					<input type="password" name="newpass" placeholder="Enter new password"class="input_field">
                      <div class="cleaner_h10"></div>
				</div>
				
				<div class="form-group">
					<label>Confirm Password</label>
					<input type="password" name="confpass" placeholder="Confirm new password"class="input_field">
                      <div class="cleaner_h10"></div>
				</div>
				
				<div class="form-group">
					<input type="submit" name="submit" value="SUBMIT" class="submit_btn float_l">
                      <div class="cleaner_h10"></div>
				</div>
				</form>
                  </div>
