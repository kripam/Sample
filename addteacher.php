...
<div id="slider">
	...
	<?php
				...
				$sql="INSERT INTO `attendancetracker`.`teacher` (`teacherid`, `password`, `dpno`, `email`, `fname`, `lname`, `address`) 
				       VALUES ('$teacherid', '$password', '$dpno', '$email', '$fname', '$lname', '$address')";
