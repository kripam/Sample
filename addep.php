        ...
        <div id="content">
          <div class="scroll">
            <div class="scrollContainer">
				...
				<div class="form-group">
					<label>Head id</label>
					<input type="number" name="hodid"  placeholder="Enter head id"class="input_field">
                      <div class="cleaner_h10"></div>
				</div>
				<div class="form-group">
    ...
    <div id="footer_left">
		...
		Designed by <a href="http://www.tooplate.com">Free HTML Templates</a><br />
				...
				if(isset($_POST['submit'])){
				    ...
				    $sql="INSERT INTO `attendancetracker`.`department` (`depno`, `depname`, `hod`, `hodid`) VALUES ('$depno', '$depname', '$hod', '$hodid')";
